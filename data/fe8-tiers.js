...
window.TIER_TIP = "<b>Trainee double-promotion:</b> Ross, Amelia, and Ewan promote at level 10 (from their trainee class), then again from their intermediate class. This gives them two full stat boosts and very high final caps — worth the EXP if started early.\n        <b>Tethys</b> is only available on Ephraim's route — this alone makes Ephraim's route the recommendation for first-time players.\n        <b>Myrrh's Dragonstone</b> has limited uses; save it for tough bosses and promoted enemies. Use a Hammerne staff to restore it.";
